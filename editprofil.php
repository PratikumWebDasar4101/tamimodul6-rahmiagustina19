...
<form action="update.php" method="post">
        <table>
			...
			<tr>
				<td>Kelas</td>
				<td>
					<input type="radio" name="kelas" value="1" <?php if($row["kelas"] == 1):echo "checked"; endif ?>>D3MI41-01
					<input type="radio" name="kelas" value="2" <?php if($row["kelas"] == 2):echo "checked"; endif ?>>D3MI41-02
					<input type="radio" name="kelas" value="3" <?php if($row["kelas"] == 3):echo "checked"; endif ?>>D3MI41-03
					<input type="radio" name="kelas" value="4" <?php if($row["kelas"] == 4):echo "checked"; endif ?>>D3MI41-04
				</td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" name="hobi[]" value="Melukis" <?php if(in_array("Melukis",$hobi)):echo "checked"; endif ?>>Melukis
					<input type="checkbox" name="hobi[]" value="Menari" <?php if(in_array("Menari",$hobi)):echo "checked"; endif ?>>Menari
					<input type="checkbox" name="hobi[]" value="Travelling" <?php if(in_array("Travelling",$hobi)):echo "checked"; endif ?>>Travelling
					<input type="checkbox" name="hobi[]" value="Online" <?php if(in_array("Online",$hobi)):echo "checked"; endif ?>>Online<br>
				</td>
			</tr>
			<tr>
				<td>Fakultas</td>
